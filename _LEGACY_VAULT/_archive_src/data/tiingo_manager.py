...
class TiingoManager:
    ...
    def fetch_daily_data(self, tickers: List[str], start_date: str = None, end_date: str = None) -> Dict[str, pd.DataFrame]:
        """
        Fetch daily data for multiple tickers (alias for get_batch_data)
        ...
        Returns:
            Dictionary of ticker -> DataFrame
        """
        return self.get_batch_data(tickers, start_date, end_date)
