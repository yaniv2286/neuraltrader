...
# Import our feature engineer for feature calculation
...
class LiveRanker:
    ...
    def __init__(self, raw_path: str = "data/raw", models_path: str = "models", logs_path: str = "logs"):
        ...
        # Initialize Feature Engineer for feature calculation
        self.feature_engineer = FeatureEngineer(use_advanced_features=True)
